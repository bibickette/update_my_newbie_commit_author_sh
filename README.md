...
_⚠️ Important: Ensure the repository path and URL point to the same repository, otherwise adding the remote will fail._
...
1. Clone `update_my_newbie_commit_author` in a folder first : `git clone https://github.com/bibickette/update_my_newbie_commit_author.git`
